...
\paragraph{}
So far, there are large uncertainties in the EM light curves, spectra of coalescing MBHBs, and in the structure and properties of the environment around MBHBs.

Around an MBHB, a circumbinary disc, and two mini discs surrounding each black hole. These mini-discs can emit large amounts of X-ray radiation.
...
\paragraph{Knowledge about MBHs with EM observations prior to LISA.}
